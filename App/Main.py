...
from PyQt5.QtWidgets import (QFileDialog, QPushButton, QLabel, QMessageBox, QVBoxLayout)
...
class Map(QDialog):
    ...
    def go_to_copernicus(self):
        ...
        if self.flag == 0:
            msg = QMessageBox()
            msg.setWindowTitle("Komunikat")
            msg.setText("Musisz najpierw zaznaczyć obszar na mapie i nacisnąć ""Export""")
            x = msg.exec_()
        elif self.image == 400:
            msg = QMessageBox()
            msg.setWindowTitle("Komunikat")
            msg.setText("Niestety nie udało się pobrać obrazu.")
            self.flag = 0
            x = msg.exec_()
            ...
            msg = QMessageBox()
            msg.setWindowTitle("Komunikat")
            msg.setText("Niestety nie udało się pobrać obrazu. Wystąpił problem z logowaniem do usługi Sentinel Hub.")
            self.flag = 0
            x = msg.exec_()
